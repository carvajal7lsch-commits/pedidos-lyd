         ...
         KPI ROW — 5 metric cards
            ...
            <div class="mapita">
                <div class="card-mapa">
                    ...
                    <div id="mapaVendedores" style="width:100%; flex: 1; min-height: 250px; border-radius:12px;overflow:hidden;"></div>
    ...
    ══════════════════════════════════════════════════════════ -->
            <div class="content-row">
                ...
                <div class="dash-card">
                    ...
                    <div class="ring-box">
                        <div class="ring-label-top">Clientes activos</div>
                        <div class="rw">
                            <svg viewBox="0 0 120 120">
                                ...
                                <circle class="rw-fill" cx="60" cy="60" r="54" id="ringFill"
